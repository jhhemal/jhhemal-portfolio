...
export default function Meta() {
    return (
        <Head>
            ...
            <meta name="author" content="Jahidul Hasan (jhhemal)" />
            <meta name="keywords"
                content="jhhemal, jhhemal's portfolio, jhhemal linux, ubuntu portfolio, Jahidul Hasan Hemal protfolio,Jahidul Hasan Hemal computer, Jahidul Hasan Hemal, jhhemal ubuntu, Jahidul Hasan Hemal ubuntu portfolio" />
